    ...
    if ($("#chart_6").length) {
        ...
        var result = new Waypoint({
            ...
            handler: function handler() {
                ...
                var data6 = {
                    labels: ["Marketing", "SEO", "Progress", "Analysis"],

                    datasets: [{
                        data: [200, 50, 100, 150],
                        backgroundColor: ["rgb(233, 30, 99)", "rgba(241,91,38,.8)", "rgba(76, 175, 80, 1)", "rgb(63, 81, 181)"],
                        hoverBackgroundColor: ["rgb(233, 30, 99)", "rgba(241,91,38,.8)", "rgba(76, 1775, 80, 1)", "rgb(63, 81, 181)"]
                    }]
                };
